...
ormconfig_1.default.initialize().then(function () {
    var productRepository = ormconfig_1.default.getRepository(product_1.Product);
    amqp.connect('amqps://soeucjcz:ZMXrYhFeGrffBaY9lkeN7-19UKj7V3Ok@lionfish.rmq.cloudamqp.com/soeucjcz', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('product_is_created_now', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            channel.consume('product_is_updated_now', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            channel.consume('product_is_deleted_now', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var admin_id;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
